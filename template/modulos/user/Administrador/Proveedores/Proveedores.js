    ...
    async cargarDescriciones() {
        ...
        var columnas = [
            { "data": "raza" },
            {
                "data": null,
                "defaultContent": '<div style="display: flex;justify-content: center;">' +
                    '<button type="button" id="btnDescripcion" class="btn btn-success mr-1 mb-1"  data-bs-toggle="modal"                            data-original-title="test" data-bs-target="#descripcionModal" ><i class="fa fa-eye"></i></button><button type="button" id="btnEliminarDescripcion" class="btn btn-danger mr-1 mb-1"><i class="fa fa-trash"></i></button>' +
                    '</div>'
            }
        ];
        ...
        this.tablaDescripcion = generarTabla2(
            'tablaDescripcion',
            `${urlServer}administracion/A_Proveedores/getDescripcion`,
            datos,
            columnas,
            columnalongitud,
            this.token
