    ...
    <h1>Política de Privacidad</h1>
        <ol>
            ...
            <li>
                ...
                Tomamos medidas razonables para proteger la información personal que nos proporcionas contra pérdida, robo, acceso no autorizado, divulgación o modificación. Sin embargo, no podemos garantizar la seguridad absoluta de la información transmitida electrónicamente.
            </li>
            <li>
                <h2>Acceso y Corrección de Datos</h2>
                Tienes derecho a acceder, corregir o eliminar tu información personal almacenada en nuestra Aplicación. Puedes hacerlo accediendo a tu cuenta o contactándonos directamente.
            </li>
            <li>
                <h2>Cambios en la Política de Privacidad</h2>
                Nos reservamos el derecho a actualizar esta política en cualquier momento. Las modificaciones se publicarán en la Aplicación y entrarán en vigor inmediatamente.
            </li>
            <li>
                <h2>Contacto</h2>
