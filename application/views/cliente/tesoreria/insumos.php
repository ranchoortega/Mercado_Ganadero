            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="col-sm-12">
                            <h3 class="text-center">SOLICITUD DE INSUMOS</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <select name="tipoSolicitud" id="tipoSolicitud" class="form-control">
                                    ...
                                    <option value="material de papeleria">Papeleria</option>
                                </select>
                            </div>
                            <div class="col-sm-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-3">
                                <label for="fecha_expedicion">Fecha de expedición del oficio:</label>
