...
class Servicios extends CI_Controller
{
	...
	public function index()
	{
		...
		$datos['estilosjs'] = plantilla_footer(
			array(
				"template/modulos/user/tesoreria/servicios.js"
			)
		);
		...
		$this->load->view('cliente/tesoreria/servicios');
	...
	public function setInsumo()
	{
		if ($this->input->post()) {
			...
			$id =  $this->RequisicionesModel->setRequisicion($idMunicipio, $idUsuario, $tipoSolicitud, $tipo_gasto, $fechaPedido, $programa, $componente, $actividad, $meta, $info, $oficio, $fecha_registro);
			echo json_encode($id);
		}
	}
}
