...
class Egresos extends CI_Controller
{
	...
	public function getEgresos()
	{
		if ($this->input->post()) {
			...
			$idMunicipio = $this->input->post('idMunicipio');
			$total = $this->EgresosModel->getEgresos(false, $inicio, $filas, $idMunicipio);
			$datos = $this->EgresosModel->getEgresos(true, $inicio, $filas, $idMunicipio);
	...
	public function getLegajosbyidegreso()
	{
		if ($this->input->post()) {
			$draw = $this->input->post('draw');
			$inicio = $this->input->post('start');
			...
			$total = $this->EgresosModel->getLegajosByIdEgreso(false, $inicio, $filas, $idegreso);
			$datos = $this->EgresosModel->getLegajosByIdEgreso(true, $inicio, $filas, $idegreso);
